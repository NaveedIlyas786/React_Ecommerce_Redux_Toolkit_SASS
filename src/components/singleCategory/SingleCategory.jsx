...
const SingleCategory = ({ products, category, status }) => {
          ...
          {products.map((product) => (
            ...
            >
              ...
              <div className="product-item-body">
                <h6 className="product-item-title text-pine-green fs-15 fw-4">
                  {product.title}
                </h6>
                <div className="product-item-price text-regal-blue fs-18 fw-7">
