...
const CartPage = () => {
  ...
  const emptyCartMessage = <h4 className="text-red fw-6">No Item's Found !</h4>;
        ...
        <div className="breadcrumb">
          <ul className="breadcrumb-items flex">
            <li className="breadcrumb-item">
              <Link to="/">
                <i className="fas fa-home" style={{marginRight:7}}></i>
                <span className="breadcrumb-seperator" style={{marginRight:7}}>
